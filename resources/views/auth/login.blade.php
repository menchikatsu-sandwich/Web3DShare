        ...
        <form method="POST" action="/login" class="flex flex-col gap-5">
            ...
            <div class="space-y-4">
                <input type="text" name="email" placeholder="Email or Username" required
                    class="w-full bg-darkBg border border-gray-800 text-gray-200 px-4 py-3 rounded-xl focus:outline-none focus:border-neon focus:ring-1 focus:ring-neon transition-all placeholder-gray-600">
