...
<div class="-m-6 lg:-m-8 bg-gray-100 dark:bg-darkBg min-h-[calc(100vh-73px)]">
    <section class="px-6 lg:px-10 py-10 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-darkPanel">
        <div class="max-w-5xl mx-auto">
            <p class="text-xs font-bold uppercase tracking-widest text-green-600 dark:text-neon mb-3">Web3DShare Legal Terms</p>
            <h1 class="text-4xl lg:text-5xl font-bold text-gray-950 dark:text-white leading-tight">EULA, Rules of Access, and Terms of Agreement</h1>
            <p class="mt-4 max-w-3xl text-gray-600 dark:text-gray-400 leading-relaxed">
                These terms govern access to Web3DShare, including accounts, uploads, downloads, model pages, comments, reports, moderation tools, and any related community features. By creating an account, uploading content, browsing models, or using any feature of this website, you agree to follow these terms.
            </p>
    ...
    <section class="px-6 lg:px-10 py-10">
        <div class="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8 items-start">
            <aside class="hidden lg:block sticky top-24 bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-5 shadow-sm">
                <h2 class="text-xs font-bold uppercase tracking-widest text-gray-400 mb-4">Contents</h2>
            ...
            <article class="space-y-6 text-gray-700 dark:text-gray-300">
                <div class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
                    <p class="text-sm leading-relaxed">
                        This page is written to clearly describe Web3DShare's operating rules. It is not a substitute for advice from a licensed legal professional. If any part of these terms is unclear, the safest interpretation is the interpretation chosen by Web3DShare administrators and developers for the protection, stability, and continuity of the website.
                    </p>
                </div>

                <section id="agreement" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">1. Acceptance of Agreement</h2>
                ...
                <section id="ownership" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">2. Website Ownership and Administrative Authority</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="accounts" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">3. Accounts and Identity</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="uploads" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">4. Uploads, Models, and Content License</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="conduct" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">5. Community Conduct</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="moderation" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">6. Moderation and Enforcement</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="downloads" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">7. Downloads and Third-Party Use</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="security" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">8. Security, Availability, and Data</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section id="termination" class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm scroll-mt-24">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">9. Suspension, Removal, and Termination</h2>
                    <div class="space-y-4 leading-relaxed">
                ...
                <section class="bg-white dark:bg-darkPanel border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
                    <h2 class="text-2xl font-bold text-gray-950 dark:text-white mb-4">10. Final Statement</h2>
                    <div class="space-y-4 leading-relaxed">
